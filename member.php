                                ...
                                <!-- <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                            <i class="zmdi zmdi-plus"></i> <a style="text-decoration: none; color: white;" href="add_member.php">add member</a></button>
...
//echo $my_id;
         $sql = 'SELECT * FROM users,subusers WHERE users.email = subusers.email AND subusers.main_user_id = '."$id".'';
         //echo $sql;
    ...
    ?>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td><?php echo $auth['firstname'];?> <?php echo $auth['lastname'];?></td>
                                                <td>
                                                    <span class="block-email"><?php echo $auth['email'];?></span>
                                                </td>
                                                
                                                <td>
                                                    <span class="status--process"><?php echo $auth['phonenumber'];?></span>
                                                </td>
                        ...
                        $id = $_POST['id'];
                                                           // echo $id;
                        $sql = "DELETE FROM `subusers` WHERE `id` = '$id'";
